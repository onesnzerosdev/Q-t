        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('formfields.index')" :active="request()->routeIs('formfields.index')">
                        {{ __('Form') }}
                    </x-nav-link>
                    <x-nav-link :href="route('submitforms.index')" :active="request()->routeIs('submitforms.index')">
                        {{ __('Submition') }}
                    </x-nav-link>
                </div>
            </div>
